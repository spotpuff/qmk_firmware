 ...
 */
	...
	[_FN] = LAYOUT_65_ansi(
		...
		XXXXXXX, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI,  RGB_SPI,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, KC_CAD,  XXXXXXX, \
		KC_CAPS, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD,  RGB_SPD,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_SLCK, KC_PAUS,           KC_APP,  XXXXXXX, \
 ...
 */
	...
	[_MEDIA] = LAYOUT_65_ansi(
		XXXXXXX, KC_F1,    KC_F2,   KC_F3,   KC_F4,   XXXXXXX, KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS, KC_PEQL,  XXXXXXX,  XXXXXXX, _______, _______, \
